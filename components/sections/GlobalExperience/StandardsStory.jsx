...
/**
 * The photographic narrative beat, mirroring components/sections/About/
 * OriginStory: image one side, copy the other, the image over-scaled and
 * parallax-drifting against the copy as the pair scrolls through.
 *
 * Absorbs the old "Technology Behind Our Kashmir Systems" section. That was a
 * heading, a paragraph and four ticked bullet points, fluoropolymer cable,
 * variable wattage, waterproof insulation, IEC compliance. The same four facts
 * are here as prose, because a tick-list of material properties tells a
 * customer what is in the cable but not why any of it matters.
 *
 * Image on the left, alternating against ValleyStory on /local-experience.
 */
