...
/**
 * Closing panel, same raised heat-lit treatment as AboutCTA, WorkingCTA,
 * HowItWorksCTA and LocalExperienceCTA so every route lands on the same note.
 */
export default function GlobalExperienceCTA() {
  return (
