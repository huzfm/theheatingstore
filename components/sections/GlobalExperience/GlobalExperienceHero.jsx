...
/**
 * Opener for /global-experience, on the same recipe as AboutHero, WorkingHero
 * and LocalExperienceHero: full-bleed backdrop, legibility grade, slow
 * breathing heat wash, grain, centred column, figures on a hairline rule, seam
 * glow into the next section.
 */
export default function GlobalExperienceHero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-ink-950 text-bone-100">
      ...
      <motion.div
        ...
        style={{
          background:
            'radial-gradient(55vw 45vh at 50% 14%, rgba(255,138,61,0.16), transparent 62%), radial-gradient(45vw 40vh at 92% 94%, rgba(255,138,61,0.06), transparent 60%)',
        }}
      />
      <div
        aria-hidden
