...
/**
 * Closing panel, same raised heat-lit treatment as AboutCTA and WorkingCTA so
 * every route lands on the same note. Its eyebrow is "Stage 01" deliberately:
 * the page has just walked through five stages, and the ask is simply the
 * first of them.
 */
