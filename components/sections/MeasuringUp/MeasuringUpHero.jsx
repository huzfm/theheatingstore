...
/**
 * Opener for /measuring-up, on the same recipe as every other route's hero:
 * full-bleed backdrop, legibility grade, slow breathing heat wash, grain,
 * centred column, figures on a hairline rule, seam glow into the next section.
 */
export default function MeasuringUpHero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-ink-950 text-bone-100">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, rgba(10,10,10,0.90) 0%, rgba(10,10,10,0.76) 42%, rgba(10,10,10,0.96) 100%)',
        }}
      />
      <motion.div
        aria-hidden
        ...
        style={{
          background:
            'radial-gradient(55vw 45vh at 50% 12%, rgba(255,138,61,0.15), transparent 62%), radial-gradient(45vw 40vh at 10% 94%, rgba(255,138,61,0.06), transparent 60%)',
        }}
      />
      <div
        aria-hidden
