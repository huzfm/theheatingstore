...
/**
 * Closing panel, same raised heat-lit treatment as AboutCTA, WorkingCTA and
 * HowItWorksCTA so every route lands on the same note.
 */
export default function LocalExperienceCTA() {
  return (
