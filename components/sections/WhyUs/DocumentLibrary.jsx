 ...
 * the part most likely to earn a link from somebody who is not buying anything
 * — which is exactly why the merged page keeps it rather than trimming it.
 *
 * The document is the subject and the logo is the identifier, not the other way
 * round. Logos sit on light plates for the same reason as the brand wall: these
 * are transparent files at wildly different aspect ratios carrying their own
 * colours, and a missing logo falls back to a wordmark rather than a broken
 * image.
 *
