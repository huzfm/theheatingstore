 ...
 * translate a full copy-width and loop seamlessly; the duplicate is aria-hidden
 * so a screen reader hears the list once.
 *
    ...
    >
      <style>{`
        ...
        .whyus-track {
          display: flex;
          width: max-content;
          animation: whyus-marquee 42s linear infinite;
        }
        .whyus-marquee:hover .whyus-track { animation-play-state: paused; }
        @media (prefers-reduced-motion: reduce) {
          .whyus-track { animation: none; }
          .whyus-marquee { overflow-x: auto; }
        }
      `}</style>
      ...
      <Link href="/certifications" className="whyus-marquee block">
