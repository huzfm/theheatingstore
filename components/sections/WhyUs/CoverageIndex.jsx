 ...
 *
 * The town names are the content here — they are what somebody searching
 * "underfloor heating Baramulla" needs to find — so they are set large in the
 * display face and given the section's visual weight rather than shrunk into
 * grey tags.
 *
