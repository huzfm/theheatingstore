...
/* Below-fold GSAP pinned timeline: code-split so it is not in this route's
   initial JavaScript. */
const WhyElectricHamam = dynamic(() => import('../components/WhyElectricHamam'), {
  ssr: false,
  loading: () => <div aria-hidden style={{ minHeight: '60vh' }} />,
});
...
function StatCounter({ stat, inView }) {
  ...
  return (
    <div className="stat-block">
      <p className="stat-number">{stat.text ?? `${value}${stat.suffix}`}</p>
...
function HeroEnquiryForm() {
  ...
  return (
    ...
    >
      <h2 className="hero-form-title">Book a Free Site Visit</h2>
...
export default function LandingClient() {
  ...
  return (
    <>
      <style>{`
        /* Fonts are loaded by next/font in ./page.jsx and exposed as CSS
           variables. The runtime @import that used to sit here was
           render-blocking and hit Google on every page view. */
        ...
        * { box-sizing: border-box; }
        ...
        .lp {
          ...
          font-family: var(--font-lp-body), sans-serif;
          background: var(--parchment);
          overflow-x: clip;
        }
        .lp h1, .lp h2, .lp h3 { font-family: var(--font-lp-display), serif; }
        .lp .mono { font-family: var(--font-lp-mono), monospace; }
        ...
        .lp-nav-logo { display: flex; align-items: center; gap: 9px; font-family: var(--font-lp-display), serif; font-style: italic; font-weight: 500; font-size: 21px; letter-spacing: 0.01em; }
        ...
        .lp-nav-link { font-size: 13px; font-weight: 500; text-decoration: none; color: var(--cream); opacity: 0.82; transition: opacity 0.2s; background: none; border: none; cursor: pointer; font-family: var(--font-lp-body), sans-serif; padding: 0; white-space: nowrap; }
        ...
        .lp-hero-badge {
          ...
          margin-bottom: 24px; font-family: var(--font-lp-mono), monospace;
        }
        ...
        .hero-form-input {
          ...
          font-family: var(--font-lp-body), sans-serif; font-size: 13.5px; color: var(--ink); background: var(--parchment);
        ...
        .hero-form-submit {
          ...
          font-family: var(--font-lp-body), sans-serif; font-weight: 600; font-size: 14px; color: var(--cream);
        ...
        .stat-number { font-family: var(--font-lp-display), serif; font-size: clamp(26px,3.2vw,38px); font-weight: 600; color: var(--copper); margin: 0 0 4px; }
        .stat-label { font-size: 12px; font-weight: 500; color: var(--walnut); opacity: 0.65; margin: 0; font-family: var(--font-lp-mono), monospace; }
      ...
      <div className="lp">
        ...
        <div id="installation" className="lp-anchor">
          {/* h2, not the component's default h1: this page already has its own
              h1 above, and two h1s on one document is what the audit flagged. */}
          <InstallationContent headingLevel="h2" />
        </div>
