...
const JSON_LD = service({
  name: "Electric Floor Heating Installation",
  description:
    "Supply and installation of UK-imported electric floor heating, laid on insulated subfloor and sealed in screed for even, silent warmth.",
});
