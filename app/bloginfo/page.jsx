export const metadata = {
  ...
  keywords: [
    ...
    "smart thermostat heating Kashmir",
    "energy efficient floor heating Kashmir",
    "heating system innovations Kashmir",
  ],
  openGraph: {
    title: "Project Features & Technology | Electric Hamam",
    description:
      "Discover the advanced features and technology behind The Heating Store's electric hamam systems.",
  },
};
